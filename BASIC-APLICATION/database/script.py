...
cursor.executemany('''INSERT INTO passeios (empresa_id, nome, tipo, vagas, vagas_ocupadas, empresa, alcance, valor, avaliacao, descricao, categoria, avaliadores) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)''', [
    ...
    (2, 'Passeio Noturno de Barco', 'Aventura', 15, 5, 'ExploraTour', 150, 250.0, 4.8, 'Passeio de barco à noite com vista da cidade', 'Aventura e Natureza', 25),
    ...
    (6, 'Aula de Yoga na Natureza', 'Lazer', 15, 5, 'Aventura X', 80, 60.0, 4.5, 'Aula de yoga ao ar livre, em meio à natureza', 'Lazer e Entretenimento', 12),
    ...
    (7, 'Passeio de Bike na Praia', 'Aventura', 20, 5, 'Turismo Seguro', 100, 70.0, 4.5, 'Passeio de bicicleta ao longo da orla', 'Aventura e Natureza', 15),
